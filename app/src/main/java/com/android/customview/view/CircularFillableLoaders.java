...
public class CircularFillableLoaders extends ImageView {
    ...
    public  final int PERCENT_BIG_TEXT_SIZE = (int) getResources().getDimension(
            R.dimen.percent_big_text_size);
    public  final int PAH_BIG_TEXT_SIZE =(int) getResources().getDimension(
            R.dimen.pah_big_text_size);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (waveShader != null) {
            ...
            percentPaint.setTextSize(PERCENT_BIG_TEXT_SIZE);

            float measurePercentWidth = percentPaint.measureText("80") / 2;
            canvas.drawText("80", circleCenter - measurePercentWidth, circleCenter + measurePercentWidth, percentPaint);


            percentPaint.setTextSize(PAH_BIG_TEXT_SIZE);
            float measurePAHWidth = percentPaint.measureText("%");
            canvas.drawText("%", circleCenter + measurePercentWidth , circleCenter + measurePercentWidth, percentPaint);
        } else {
